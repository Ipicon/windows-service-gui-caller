...
public class FolderSelectDialog {
    ...
    // file dialog needs this folder to exist, before it has been initialized
    private void CreateIfMissingDesktop() {
...
$path = ([FolderSelectDialog]::new($path, $title, $message)).getPath()

# like a web hook telling the server we finished
Add-Type -AssemblyName System.Web
$encpath = [System.Web.HttpUtility]::UrlEncode($path)
Invoke-WebRequest  -Uri "http://localhost:3000/finish-folder-select?path=$encpath"
